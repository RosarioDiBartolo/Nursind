...
3. `src/extract_events_from_text_raw.py`
4. `src/filter_midnight_events_from_days_raw.py`
5. `src/pair_employee_events_from_days_raw.py`
...
- Events/clean/pair: `python -m "src.extract_events_from_text_raw"`, `python -m "src.filter_midnight_events_from_days_raw"`, `python -m "src.pair_employee_events_from_days_raw"`
