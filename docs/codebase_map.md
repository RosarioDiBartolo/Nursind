...
- Prefer package `service.py` and `runtime.py` over notebooks when tracing execution.
...
| Parser recall QA | `src/parser_recall_audit/runtime.py`, `src/parser_recall_audit/service.py` | `src/drive_service/text_extraction_csv.py`, `src/extract_events_from_documents/page_analysis.py` | `tests/test_parser_recall_audit.py` | Service currently mixes input loading, heuristics, and scoring. |
| Midnight cleanup | `src/filter_midnight_events/runtime.py`, `src/filter_midnight_events/service.py` | none beyond pandas-level cleanup helpers in the package | `tests/test_filter_midnight_events_step_contract.py` | Small, focused package. |
...
| Enrich shifts | `src/turni_enrichment/runtime.py`, `src/turni_enrichment/service.py` | `src/shift_services.py` | `tests/test_turni_enrichment_step_contract.py` | Uses shared holiday and shift classification helpers. |
| Aggregate yearly summary | `src/turni_employee_summary/runtime.py`, `src/turni_employee_summary/service.py` | `src/shift_services.py` | `tests/test_turni_employee_summary_step_contract.py` | Output-focused package. |
| Missing timbrature audit | `src/timbrature_missing_report/runtime.py`, `src/timbrature_missing_report/service.py` | `src/timbrature_missing_report/inputs.py`, `src/timbrature_missing_report/accumulator.py`, `src/timbrature_missing_report/issues.py`, `src/drive_service/text_extraction_csv.py` | `tests/test_timbrature_missing_report.py` | Read `inputs.py` first for layout assumptions. |
