...
def _enrich_pairs(
    ...
    *,
    ...
    working = working.assign(
        turno_code=assign_turno_code(working),
        turno_bucket=assign_turno_bucket(working, min_hours=min_hours),
    )
