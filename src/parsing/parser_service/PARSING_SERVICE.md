...
Entry points:
- Programmatic: `parsing.parse_pdf`
- CLI: `python -m parsing.cli parse --input <FILE|DIR> --out <DIR>`

## 2) Document Detection (router)

File: `src/parsing/parser_service/router.py`
...
Files:
- `src/parsing/parsers/cartellino/parser.py`
- `src/parsing/parsers/cartellino/parse_days.py`
- `src/parsing/parsers/cartellino/parse_pairs.py`
- `src/parsing/parsers/cartellino/parse_totals.py`

Flow:
1. **Text extraction** via `parser_shared.extract.extract_text`.
2. If no day lines → try `extract_text_vertical`.
3. **Metadata** from `parsing.parsers.cartellino.utils.parse_month_year` and `parse_employee`.
...
Files:
- `src/parsing/timbrature_shared/parser_base.py`
- `src/parsing/timbrature_shared/parse_pairs.py`
- `src/parsing/timbrature_shared/parse_totals.py`
- `src/parsing/timbrature_shared/utils.py`
...
File: `src/parsing/parsers/timbrature_elenco/parse_days.py`
...
File: `src/parsing/parsers/timbrature_compact/parse_days.py`
...
File: `src/parsing/timbrature_shared/parse_pairs.py`
...
File: `src/parsing/timbrature_shared/adjust.py`
...
File: `src/parsing/parser_shared/validate.py`
...
Command:
```
python -m parsing.cli parse --input <FILE|DIR> --out <DIR> [--recursive] [--debug-detect] [--dump-text]
```
...
Command:
```
python -m parsing.parser_service.check_samples --samples samples --out samples/output --sample 1.0 --extract-if-missing
```
